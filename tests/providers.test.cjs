...
test('REAL requests produce copy only for their own locale (tr, en, es, pt, ar, fr, de, it, ja, ko) through both providers',async()=>{
 for(const provider of ['openai','anthropic'])for(const locale of ['tr','en','es','pt','ar','fr','de','it','ja','ko'])for(const mode of ['mirror','stalk','match']){
 ...
 for(const locale of ['zh','ru','xx','ko-KR','pt-BR','ar-SA','fr-FR','de-DE','it-IT','ja-JP']){
