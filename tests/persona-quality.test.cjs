...
test('nickname guard rejects forced compounds and sensitive labels in every locale',()=>{
 ...
 const bad={
  ...
  ru:['Машина вопросов','Пожарный драмы','Радар настроения','Охотник за ответами','Турист таймлайна','Бархатная логика','Квантовая ложка','Биполярный гений','Аутичный писатель','Мусульманский рассказчик','Гей мыслитель','Курдский писатель','Депрессивный поэт','Легендарный герой','Curious Mind','Любопытный Mind','Очень очень','Тихий наблюдатель который всегда всё замечает и молчит'],
...
test('REAL fallback is safe, deterministic and signal based without another AI call',()=>{
 ...
 const unnatural={tr:'Soru Makinesi',en:'Question Machine',es:'Máquina de Preguntas',pt:'Máquina de Perguntas',ar:'آلة الأسئلة',fr:'Machine à Questions',de:'Die Fragemaschine',it:'Macchina delle Domande',ja:'質問マシーン',ko:'질문 기계',zh:'問題機器',ru:'Машина вопросов'};
 for(const signals of cases)for(const locale of ['tr','en','es','pt','ar','fr','de','it','ja','ko','zh','ru']){
