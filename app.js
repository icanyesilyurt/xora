/* ============================================================
   XORA — app.js
   Ortak mantık: depolama, krediler, dil (TR/EN/ES/PT/AR/FR), üst bar, toast
   ============================================================ */
...
var LANGS = ["tr", "en", "es", "pt", "ar", "fr"];
var RTL_LANGS = ["ar"];
var LANG_NAMES = { tr: "Türkçe", en: "English", es: "Español", pt: "Português", ar: "العربية", fr: "Français" };
