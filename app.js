/* ============================================================
   XORA — app.js
   Ortak mantık: depolama, krediler, dil (TR/EN/ES/PT/AR/FR/DE), üst bar, toast
   ============================================================ */
...
var I18N = {
  ...
  fr: {
    ...
    match_vibe: "Même longueur d'onde",
...
var LANGS = ["tr", "en", "es", "pt", "ar", "fr", "de"];
var RTL_LANGS = ["ar"];
var LANG_NAMES = { tr: "Türkçe", en: "English", es: "Español", pt: "Português", ar: "العربية", fr: "Français", de: "Deutsch" };
