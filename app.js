...
var I18N = {
  tr: {
    ...
    share_measured: "gerçek X verisinden ölçüldü",
    share_says_mirror: "XORA sana diyor ki",
    share_says_stalk: "XORA'nın notu",
    share_says_match: "Kimya raporu",
    share_none: "Yok",
    share_case: "DOSYA",
    stalk_t_repost: "Gündem Takibi",
    stalk_t_original: "Kendi Sesi",
    stalk_t_reply: "Sohbet Eğilimi",
    stalk_t_length: "Metin Tarzı",
    stalk_u_repost: "repost",
    stalk_u_original: "özgün gönderi",
    stalk_u_reply: "yanıt",
    stalk_u_length: "karakter ort.",
    match_band_strong: "Güçlü",
    match_band_clear: "Belirgin",
    match_band_moderate: "Orta",
    match_band_low: "Düşük",
  ...
  en: {
    ...
    share_measured: "measured from real X data",
    share_says_mirror: "XORA tells you",
    share_says_stalk: "XORA's note",
    share_says_match: "Chemistry report",
    share_none: "None",
    share_case: "FILE",
    stalk_t_repost: "Timeline Watch",
    stalk_t_original: "Own Voice",
    stalk_t_reply: "Chat Tendency",
    stalk_t_length: "Writing Style",
    stalk_u_repost: "reposts",
    stalk_u_original: "original posts",
    stalk_u_reply: "replies",
    stalk_u_length: "chars avg",
    match_band_strong: "Strong",
    match_band_clear: "Clear",
    match_band_moderate: "Moderate",
    match_band_low: "Low",
  ...
  es: {
    ...
    share_measured: "medido con datos reales de X",
    share_says_mirror: "XORA te dice",
    share_says_stalk: "La nota de XORA",
    share_says_match: "Informe de química",
    share_none: "Ninguno",
    share_case: "EXPEDIENTE",
    stalk_t_repost: "Radar de Tendencias",
    stalk_t_original: "Voz Propia",
    stalk_t_reply: "Modo Charla",
    stalk_t_length: "Estilo de Texto",
    stalk_u_repost: "reposts",
    stalk_u_original: "publicaciones propias",
    stalk_u_reply: "respuestas",
    stalk_u_length: "caracteres de media",
    match_band_strong: "Fuerte",
    match_band_clear: "Clara",
    match_band_moderate: "Media",
    match_band_low: "Baja",
  ...
  pt: {
    ...
    real_m_chars: "{n} caracteres",
    share_measured: "medido com dados reais do X",
    share_says_mirror: "A XORA te diz",
    share_says_stalk: "A nota da XORA",
    share_says_match: "Relatório de química",
    share_none: "Nenhum",
    share_case: "DOSSIÊ",
    stalk_t_repost: "Radar de Assuntos",
    stalk_t_original: "Voz Própria",
    stalk_t_reply: "Clima de Papo",
    stalk_t_length: "Estilo de Texto",
    stalk_u_repost: "reposts",
    stalk_u_original: "posts originais",
    stalk_u_reply: "respostas",
    stalk_u_length: "caracteres em média",
    match_band_strong: "Forte",
    match_band_clear: "Clara",
    match_band_moderate: "Média",
    match_band_low: "Baixa",
  ...
  ar: {
    ...
    real_m_chars: "{n} حرف",
    share_measured: "مقيس من بيانات X حقيقية",
    share_says_mirror: "XORA تقول لك",
    share_says_stalk: "ملاحظة XORA",
    share_says_match: "تقرير الكيمياء",
    share_none: "لا يوجد",
    share_case: "ملف",
    stalk_t_repost: "متابعة الترند",
    stalk_t_original: "صوته الخاص",
    stalk_t_reply: "ميله للحوار",
    stalk_t_length: "أسلوب الكتابة",
    stalk_u_repost: "إعادة نشر",
    stalk_u_original: "منشورات أصلية",
    stalk_u_reply: "ردود",
    stalk_u_length: "حرفًا في المتوسط",
    match_band_strong: "قوي",
    match_band_clear: "واضح",
    match_band_moderate: "متوسط",
    match_band_low: "منخفض",
  ...
  fr: {
    ...
    share_measured: "mesuré sur de vraies données X",
    share_says_mirror: "XORA te dit",
    share_says_stalk: "La note de XORA",
    share_says_match: "Rapport de chimie",
    share_none: "Aucun",
    share_case: "DOSSIER",
    stalk_t_repost: "Veille d'actu",
    stalk_t_original: "Voix propre",
    stalk_t_reply: "Goût du dialogue",
    stalk_t_length: "Style d'écriture",
    stalk_u_repost: "reposts",
    stalk_u_original: "posts originaux",
    stalk_u_reply: "réponses",
    stalk_u_length: "caractères en moyenne",
    match_band_strong: "Forte",
    match_band_clear: "Nette",
    match_band_moderate: "Moyenne",
    match_band_low: "Faible",
  ...
  de: {
    ...
    share_measured: "gemessen an echten X-Daten",
    share_says_mirror: "XORA sagt dir",
    share_says_stalk: "XORAs Notiz",
    share_says_match: "Chemie-Bericht",
    share_none: "Keine",
    share_case: "AKTE",
    stalk_t_repost: "Trend-Radar",
    stalk_t_original: "Eigene Stimme",
    stalk_t_reply: "Gesprächslust",
    stalk_t_length: "Schreibstil",
    stalk_u_repost: "Reposts",
    stalk_u_original: "eigene Posts",
    stalk_u_reply: "Antworten",
    stalk_u_length: "Zeichen im Schnitt",
    match_band_strong: "Stark",
    match_band_clear: "Deutlich",
    match_band_moderate: "Mittel",
    match_band_low: "Gering",
  ...
  it: {
    ...
    share_measured: "misurato su dati reali di X",
    share_says_mirror: "XORA ti dice",
    share_says_stalk: "La nota di XORA",
    share_says_match: "Report di chimica",
    share_none: "Nessuno",
    share_case: "FASCICOLO",
    stalk_t_repost: "Radar sui trend",
    stalk_t_original: "Voce propria",
    stalk_t_reply: "Voglia di chiacchiere",
    stalk_t_length: "Stile di scrittura",
    stalk_u_repost: "repost",
    stalk_u_original: "post originali",
    stalk_u_reply: "risposte",
    stalk_u_length: "caratteri in media",
    match_band_strong: "Forte",
    match_band_clear: "Netta",
    match_band_moderate: "Media",
    match_band_low: "Bassa",
  ...
  ja: {
    ...
    real_m_length: "平均の長さ",
    real_m_chars: "{n}文字",
    share_measured: "実際のXデータから計測",
    share_says_mirror: "XORAからひとこと",
    share_says_stalk: "XORAのメモ",
    share_says_match: "相性レポート",
    share_none: "なし",
    share_case: "ファイル",
    stalk_t_repost: "トレンド追跡",
    stalk_t_original: "自分の声",
    stalk_t_reply: "会話傾向",
    stalk_t_length: "文章スタイル",
    stalk_u_repost: "リポスト",
    stalk_u_original: "オリジナル投稿",
    stalk_u_reply: "リプライ",
    stalk_u_length: "文字（平均）",
    match_band_strong: "強い",
    match_band_clear: "はっきり",
    match_band_moderate: "ふつう",
    match_band_low: "低い",
  ...
  ko: {
    ...
    real_m_length: "평균 길이",
    real_m_chars: "{n}자",
    share_measured: "실제 X 데이터로 측정",
    share_says_mirror: "XORA가 전하는 말",
    share_says_stalk: "XORA의 메모",
    share_says_match: "케미 리포트",
    share_none: "없음",
    share_case: "파일",
    stalk_t_repost: "트렌드 추적",
    stalk_t_original: "자기 목소리",
    stalk_t_reply: "대화 성향",
    stalk_t_length: "글 스타일",
    stalk_u_repost: "리포스트",
    stalk_u_original: "직접 쓴 글",
    stalk_u_reply: "답글",
    stalk_u_length: "자 평균",
    match_band_strong: "강함",
    match_band_clear: "뚜렷함",
    match_band_moderate: "보통",
    match_band_low: "낮음",
  ...
  zh: {
    ...
    real_m_length: "平均長度",
    real_m_chars: "{n} 字",
    share_measured: "根據真實 X 資料測得",
    share_says_mirror: "XORA 想對你說",
    share_says_stalk: "XORA 的筆記",
    share_says_match: "化學反應報告",
    share_none: "無",
    share_case: "檔案",
    stalk_t_repost: "追蹤話題",
    stalk_t_original: "自己的聲音",
    stalk_t_reply: "聊天傾向",
    stalk_t_length: "文字風格",
    stalk_u_repost: "轉發",
    stalk_u_original: "原創貼文",
    stalk_u_reply: "回覆",
    stalk_u_length: "字（平均）",
    match_band_strong: "強",
    match_band_clear: "明顯",
    match_band_moderate: "普通",
    match_band_low: "低",
  ...
  ru: {
    ...
    real_m_chars: "{n} симв.",
    share_measured: "по реальным данным X",
    share_says_mirror: "XORA говорит тебе",
    share_says_stalk: "Заметка XORA",
    share_says_match: "Отчёт о химии",
    share_none: "Нет",
    share_case: "ДОСЬЕ",
    stalk_t_repost: "Радар трендов",
    stalk_t_original: "Свой голос",
    stalk_t_reply: "Тяга к диалогу",
    stalk_t_length: "Стиль текста",
    stalk_u_repost: "репостов",
    stalk_u_original: "своих постов",
    stalk_u_reply: "ответов",
    stalk_u_length: "символов в среднем",
    match_band_strong: "Сильная",
    match_band_clear: "Заметная",
    match_band_moderate: "Средняя",
    match_band_low: "Низкая",
